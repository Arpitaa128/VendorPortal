...
urlpatterns = [
    ...
    path(
    "quotations/approve/<int:id>/",
    views.approve_quotation,
    name="approve_quotation"
),

path(
    "quotations/reject/<int:id>/",
...
path(
    "invoice/approve/<int:id>/",
    views.approve_invoice,
    name="approve_invoice",
),

path(
    "invoice/reject/<int:id>/",
    views.reject_invoice,
    name="reject_invoice",
),
...
path(
    "vendor/quotations/",
    views.vendor_quotation_list,
    name="vendor_quotation_list"
),
...
path(
    "purchase-orders/edit/<int:id>/",
    views.edit_purchase_order,
    name="edit_purchase_order"
),

path(
    "purchase-orders/delete/<int:id>/",
    views.delete_purchase_order,
    name="delete_purchase_order"
),
path(
    "purchase-orders/create/<int:quotation_id>/",
